...
3. 选择【账户安全】更改密保，“双重认证”自行决定是否开启（开启即绑定手机号更安全）。

注：若显示密码错误，打开[忘记密码](https://iforgot.apple.com/)通过安全问题(密保)重置密码。
...
打开[官网](https://iforgot.apple.com)根据密保修改密码。
...
商店地址：[点击这里](https://github.com/ssnhd/sim)
